...
$resourceType = sanitizeInput($_POST['resource_type'] ?? ''); // Extra field for project enquiry
...
try {
    // Email configuration
    $to = 'lokhandwalahvsbizz@gmail.com'; // Change this
    $subject = 'Project Enquiry from ' . $name . ' - ' . $resourceType;
    ...
    <head>
        <style>
            ...
            .header { background-color: #6f42c1; color: white; padding: 15px; border-radius: 5px; margin-bottom: 20px; }
            .field { margin-bottom: 15px; padding: 10px; background-color: #f8f9fa; border-left: 4px solid #6f42c1; }
            .label { font-weight: bold; color: #555; }
            .value { margin-left: 10px; }
            .footer { margin-top: 30px; font-size: 12px; color: #666; border-top: 1px solid #eee; padding-top: 15px; }
            .resource-type { background-color: #e7f3ff; border: 1px solid #b3d7ff; padding: 10px; border-radius: 5px; margin-bottom: 20px; }
        </style>
    <!-- Google tag (gtag.js) -->
